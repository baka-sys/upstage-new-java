...
public class CustomerSetupDTO {
    ...
    public CustomerSetupDTO() {}

    public CustomerSetupDTO(CustomerSetup entity) {
        BeanUtils.copyProperties(entity,this);
    }

    public static CustomerSetupDTO convert(CustomerSetup entity) {
        return new CustomerSetupDTO(entity);
    }

    public static List<CustomerSetupDTO> convertList(List<CustomerSetup> list) {
        List<CustomerSetupDTO> resultList = new ArrayList<>();
        for (CustomerSetup entity : list) {
            resultList.add(new CustomerSetupDTO(entity));
        }
        return resultList;
    }}
