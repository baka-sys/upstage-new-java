...
public class SayHelloVO {
    ...
    public static SayHello convert(SayHelloVO vo) {
        SayHello entity = new SayHello();
        BeanUtils.copyProperties(vo,entity);
        return entity;
    }
    public static List<SayHello> convertList(List<SayHelloVO> list) {
        List<SayHello> resultList = new ArrayList<>();
        for (SayHelloVO vo : list) {
